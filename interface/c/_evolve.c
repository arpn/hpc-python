...
#ifdef PYPY_VERSION
PyMODINIT_FUNC
_cffi_pypyinit__evolve(const void *p[])
{
...
#  ifdef _MSC_VER
     PyMODINIT_FUNC
#  if PY_MAJOR_VERSION >= 3
     PyInit__evolve(void) { return NULL; }
#  else
     init_evolve(void) { }
#  endif
#  endif
...
PyInit__evolve(void)
{
  return _cffi_init("_evolve", 0x2601, &_cffi_type_context);
}
#else
PyMODINIT_FUNC
init_evolve(void)
{
  _cffi_init("_evolve", 0x2601, &_cffi_type_context);
}
#endif
